...
export class Backend implements backendInterface {
    ...
    async quickPick(): Promise<Ticket> {
        if (this.processError) {
            try {
                const result = await this.actor.quickPick();
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async simulate(arg0: Ticket): Promise<SimulationResult> {
        if (this.processError) {
            try {
                const result = await this.actor.simulate(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
